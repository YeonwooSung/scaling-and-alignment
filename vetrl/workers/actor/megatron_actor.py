...
from vetrl.utils.megatron.optimizer_config import OptimizerConfig
...
from vetrl.utils.megatron.tensor_parallel import vocab_parallel_compute_entropy_loss, vocab_parallel_log_probs_from_logits
from vetrl.utils.megatron.pipeline_parallel import (compute_transformers_input_shapes, make_batch_generator)
from vetrl import DataProto
from vetrl.trainer.ppo import core_algos
from vetrl.workers.actor import BasePPOActor
from vetrl.utils.py_functional import append_to_dict
from vetrl.utils.torch_functional import logprobs_from_logits, broadcast_dict_tensor, split_dict_tensor_into_batches
